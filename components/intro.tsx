...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I'm Roldex Stark.</span> I am a
        versatile <span className="font-bold">full-stack developer</span> with a
        core focus on <span className="underline">Next.js</span>, a proficiency
        in <span className="font-bold">Python development</span>, and expertise
        in <span className="font-bold">Flutter development</span>.
      </motion.h1>
